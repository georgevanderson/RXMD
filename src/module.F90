...
integer,parameter :: Ntimer=30 ! variable for timing

integer,parameter :: NTABLE=5000 ! max potential table elements

! data type to describe MD system
type md_context_type
...
!-----------------------------------------------------------------------------------------------------------------------
subroutine initialize_md_context(mcx)
use MemoryAllocator
!-----------------------------------------------------------------------------------------------------------------------
implicit none
